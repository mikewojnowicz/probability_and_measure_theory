...
\begin{remark}
To motivate Definition \ref{def:positive_negative_and_null_sets} (c), consider that unlike measures, \textit{signed} measures do not have the monotonicity property. Thus, the condition $\nu(A)=0$ in isolation provides no information about the value of $\nu$ on subsets. 
\end{remark}
