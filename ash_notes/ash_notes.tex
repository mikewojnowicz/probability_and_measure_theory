...
\red{TODO: Add proof of part (b)}

%{prob:in_a_complete_metric_space_you_are_a_measurable_function_if_you_are_equal_to_some_other_measurable_function_ae}
...
\begin{align*}
S^+(f,P) &:= \ds\sum_{i=1}^n M_k (x_i - x_{i-1}) \\
