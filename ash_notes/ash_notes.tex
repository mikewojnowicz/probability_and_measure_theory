...
The only theorems that require additional comment are the triangle inequality (Prop~\ref{prop:properties_of_integrals_of_arbitrary_borel_measurable_functions} c), dominated convergence theorem \red{TODO: give link}, and transfer of integrability (Cor~\ref{cor:additivity_corollaries} (a)).  See \cite[pp.~84]{ash2000probability} for the first two. We show the latter here.   
...
\[ \int_\Omega |f| \dmu \stackexplain{by B}{\leq} \int_\Omega |\Im f|  +  |\Re f| \dmu \stackexplain{linearity}{=}  \int_\Omega |\Im f| \dmu + \int_\Omega |\Re f| \dmu  \stackrel{hypothesis}{<} \infty \]
