...
\begin{problem}{\remarktitle{\cite{folland1999real} Problem 3.2.8a}}
Let $\nu$ be a signed measure and $\mu$ a measure on a measurable space $(\Omega, \F)$.  Then 
\[ \nu \ll \mu \quad \text{iff} \quad |\nu| \ll \mu \]
In other words, a signed measure is absolutely continuous iff its total variation is absolutely continuous.
\label{prob:signed_measure_is_absolutely_continuous_iff_its_total_variation_is_absolutely_continuous}
\end{problem}
...
\begin{proof}
First recall
\[ \nu \ll \mu \stackexplain{Problem \ref{prob:signed_measure_is_absolutely_continuous_iff_its_total_variation_is_absolutely_continuous}}{\iff} |\nu| \ll \mu \]
