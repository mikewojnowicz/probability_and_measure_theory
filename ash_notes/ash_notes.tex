...
\begin{exercise}
Proposition \ref{prop:additivity_of_integral_for_non_negative_Borel_measurable_functions} actually extends to linearity with countably infinite sums.  This can be proven fairly easily with induction and yet another application of the monotone convergence theorem. Do it. 
\end{exercise}
