...
\end{remark}
  ...
  \subsection{$\S$ 1.4.5 Properties of Lesbesgue-Stietljes measure }
...
But we couldn't make that statement by the piece-and-whole decomposition (see Theorem \ref{thm:basic_properties_of_finitely_additive_set_functions}), since $\mu$ isn't necessarily finite.
\end{remark}
