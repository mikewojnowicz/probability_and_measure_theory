...
Let $\G$ be the class of subsets that have the desired result.\footnote{The reader may recognize that we are using the ``good sets" strategy.  See Section \ref{sec:good_sets_strategy}.} 
	\begin{itemize}
