...
\begin{definition}
The \textbf{product $\sigma$-field} $\A \bigotimes \B$ is the $\sigma$-field on $X \times Y$ generated by the collection of all measurable rectangles.
...
\begin{proposition}{\remarktitle{All sections of a measurable set are measurable.}} If $(X,\A)$ and $(Y,\B)$ are measurable spaces, and $E \in \A \otimes \B$, then $E_x \in Y$ for every $x \in X$ and $E_y \in X$ for every $y \in Y$. 
\end{proposition}
