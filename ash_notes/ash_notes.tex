...
As will become clear in Section~\ref{sec:signed_measures}, another name for Thm. \ref{thm:integrals_are_countably_additive_set_functions} is \textit{integrals as signed measures}.	
\end{remark}

\begin{remark}{\textbf{Change of measure.}} \cite[pp.~24]{rudin1987real} points out an important implication of Corollary \ref{cor:integrals_as_measures}: if $f \geq 0$, and so $\lambda$ (as defined as in the theorem statement) is a measure, then
\begin{align*}
