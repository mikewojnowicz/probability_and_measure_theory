...
Let the hypotheses of LOTUS hold. 
...
\end{array}
\]
Note that applying Thm.~\ref{thm:relating_lebesgue_and_riemann_integrals} would require that $gf$ be continuous a.e.; check whether this is true.
