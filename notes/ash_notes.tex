...
\red{TODO: Give other reasons -- e.g., probably, projection.}
...
\begin{example}\remarktitle{A measurable partition \textnormal{(whose cells all have positive probability)} is composed of atoms \textnormal{(of the minimal $\sigma$-field containing them)}.}    Let $(\Omega, \F, 
