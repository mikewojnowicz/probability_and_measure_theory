...
\begin{theorem} \textbf{The law of total expectation.} 
\[ \E[\E[Y \cond \G]] = \E[Y]\]
\end{theorem}
...
\begin{theorem}\textbf{``Taking out what is known."}
...
It remains to verify Equation (1).  Now $Z \in L^2(\Omega, \G, P)$ since it is a subspace, so by Theorem~\ref{thm:measurable_random_variables_behave_like_constants_with_respect_to_conditional_expectations}, we have
\begin{align*}
