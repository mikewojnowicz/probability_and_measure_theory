...
\underline{Second Result:} Now we show that $\E[Y_n] \leq E[X_n]$, with equality in the martingale case.  We proceed by induction.    The base case $\E[X_1] = \E[Y_1]$ holds by definition of $Y_n$.  Now perform the step. Suppose $\E[X_n] = \E[Y_n]$.  Then
%
\begin{align*}
...
with the latter inequality holding by induction hypothesis (and linearity of expectation for integrable RV's).
\end{proof}
