...
\begin{theorem}\textbf{Existence of conditional expectation.} \\
Let
\begin{align*}
...
\begin{question}
Can we better motivate the equality defining conditional expectation in Thm.~\ref{thm:existence_of_conditional_expectation}?  For example, why do we not define $\E[Y \cond X=x]$ as the function $g(x)$ satisfying 
