...
\begin{remark}
\citet[pp.~35]{evans2012introduction} refers to Prop.~\ref{prop:submartingale_chebyshev_inequality} as a generalization of Chebyshev's inequality.  We might refer to it as \enquote{Chebyshev's Inequality for Submartingales}. 
\end{remark}
...
&=  \sum_{k=1}^n \int X_k \indicate{A_k}\wrt{P} && \scripttext{def $A_k$, notation} \\
