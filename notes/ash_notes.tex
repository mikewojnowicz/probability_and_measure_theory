...
\end{align}
\Eqref{eqn:perfect_information_a_stronger_statement}	is stronger than \Eqref{eqn:perfect_information_again}; all knowledge about $Y$ is encoded in $\sigma(Y)$; any other set in $\F$ provides no value.  
